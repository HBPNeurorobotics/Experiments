...
@nrp.MapSpikeSource("red_left_eye1", nrp.brain.circuit[0], nrp.poisson, delay=0.1, weight=1.0)
@nrp.MapSpikeSource("red_left_eye2", nrp.brain.circuit[2], nrp.poisson, delay=0.1, weight=1.0)
@nrp.MapSpikeSource("red_right_eye1", nrp.brain.circuit[1], nrp.poisson, delay=0.1, weight=1.0)
@nrp.MapSpikeSource("red_right_eye2", nrp.brain.circuit[3], nrp.poisson, delay=0.1, weight=1.0)
@nrp.MapSpikeSource("green_blue_eye", nrp.brain.circuit[4], nrp.poisson, delay=0.1, weight=1.0)
@nrp.Robot2Neuron()
