...
def linear_twist(t, left_wheel_neuron, right_wheel_neuron):
    ...
    return geometry_msgs.msg.Twist(
        linear=geometry_msgs.msg.Vector3(x=30.0 * min((abs(left_wheel_neuron.value[0]), abs(right_wheel_neuron.value[0]))), y=0.0,
                                         z=0.0),
        angular=geometry_msgs.msg.Vector3(x=0.0, y=0.0, z=50.0 * (
            right_wheel_neuron.value - left_wheel_neuron.value)))
