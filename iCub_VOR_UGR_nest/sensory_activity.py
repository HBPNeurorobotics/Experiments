...
@nrp.MapSpikeSource("MF_pos_activity", nrp.map_neurons(range(0, 50), lambda i: nrp.brain.MF_pos[i]),
                    nrp.poisson, delay=1.0)
@nrp.MapSpikeSource("MF_vel_activity", nrp.map_neurons(range(0, 50), lambda i: nrp.brain.MF_vel[i]),
                    nrp.poisson, delay=1.0)
