...
@nrp.MapSpikeSink("agonist_neuron", nrp.brain.VN_agonist[slice(0, 100, 1)],
                  nrp.population_rate, tau_fall=20.0, tau_rise=10.0)
@nrp.MapSpikeSink("antagonist_neuron", nrp.brain.VN_antagonist[slice(0, 100, 1)],
                  nrp.population_rate, tau_fall=20.0, tau_rise=10.0)
